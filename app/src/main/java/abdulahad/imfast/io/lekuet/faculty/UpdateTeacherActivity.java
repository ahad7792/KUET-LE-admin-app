...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private EditText updateTeacherName, updateTeacherEmail, updateTeacherPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTeacherImage = findViewById(R.id.upadteTeacherImage);
        updateTeacherName = findViewById(R.id.upadateTeacherName);
        updateTeacherPhone = findViewById(R.id.upadateTeacherPhone);
        updateTeacherEmail = findViewById(R.id.upadateTeacherEmail);
        ...
        try {
            Picasso.get().load(image).placeholder(R.drawable.avatarprofile).into(updateTeacherImage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        reference.child(category).child(uniqueKey).removeValue()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(UpdateTeacherActivity.this, "Teacher Data Deleted", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(UpdateTeacherActivity.this, UpdateFaculty.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                    }
