...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Industrial Tour", "Seminars", "Other Events"};
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bitmap == null){
                    Toast.makeText(UploadImage.this, "Please choose an image from gallery", Toast.LENGTH_SHORT).show();
