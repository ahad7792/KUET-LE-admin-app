...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Post", "Professor", "Associate Professor", "Assistant Professor", "Lecturer"};
    ...
    private void checkValidation() {
        ...
        }else if(category.equals("Select post")){
            Toast.makeText(this, "Please provide teacher's mobile number", Toast.LENGTH_SHORT).show();
        }else if(bitmap == null){
